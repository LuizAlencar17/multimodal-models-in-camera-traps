...
flags.DEFINE_string('train_filename', help='',
                    default='/data/luiz/dataset/partitions/species-classifier/serengeti/train.csv')
flags.DEFINE_string('val_filename', help='',
                    default='/data/luiz/dataset/partitions/species-classifier/serengeti/val.csv')
flags.DEFINE_string('test_filename', help='',
                    default='/data/luiz/dataset/partitions/species-classifier/serengeti/test.csv')
flags.DEFINE_string('checkpoint_path', help='',
                    default='/data/luiz/dataset/models/species-classifier/')
flags.DEFINE_string('results_path', help='',
                    default='/data/luiz/dataset/results/species-classifier/')
